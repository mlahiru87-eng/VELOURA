...
import { ExternalLink, Sparkles, X, Zap, ShieldCheck, Flame } from 'lucide-react';
...
export const AdBanner: React.FC<AdBannerProps> = ({ 
  ...
  const directAdLink = `https://www.effectivecpmnetwork.com/acytcm6ag?key=${adKey}`;
  ...
  if (type === 'banner') {
    return (
      <div className={`w-full flex flex-col items-center justify-center my-6 px-4 ${className}`} id={id}>
        ...
        {/* Adsterra Display Banner & Live Iframe */}
        <div className="w-full flex flex-col items-center justify-center gap-3">
          
          {/* Mobile Display: 320x50 Adsterra Live Frame */}
          <div className="block md:hidden w-[320px] h-[60px] overflow-hidden rounded-xl bg-zinc-950 border border-gold-500/20 shadow-md relative">
            <iframe
              ...
              scrolling="no"
              frameBorder="0"
              className="w-[320px] h-[60px] border-0 overflow-hidden"
              sandbox="allow-scripts allow-same-origin allow-popups allow-forms"
            />
          </div>

          {/* Desktop Display: 728x90 Adsterra Live Frame */}
          <div className="hidden md:block w-[728px] h-[95px] overflow-hidden rounded-2xl bg-zinc-950 border border-gold-500/20 shadow-lg relative">
            <iframe
              ...
              scrolling="no"
              frameBorder="0"
              className="w-[728px] h-[95px] border-0 overflow-hidden"
              sandbox="allow-scripts allow-same-origin allow-popups allow-forms"
            />
          </div>

          {/* Direct Link Interactive Sponsor Card */}
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div className="text-left">
                  <div className="text-xs font-bold text-white tracking-wide flex items-center gap-1.5">
                    <span>Veloura VIP High-Speed Mirror</span>
                    <span className="bg-gold-500/20 text-gold-300 text-[8px] font-mono px-1 rounded">SPONSOR</span>
                  </div>
                  <div className="text-[10px] text-zinc-400">Click to connect to fast 4K streaming server (Adsterra Direct)</div>
                </div>
              </div>
  ...
  // Type 2: Direct Ad Link promo container
  return (
        ...
        <div className="flex items-center gap-3.5 self-start sm:self-center">
          ...
          <div>
            <div className="flex items-center gap-1.5 flex-wrap">
              <h4 className="text-xs md:text-sm font-serif font-bold text-white">⚡ Fast Buffer-Free Sponsor Server</h4>
            ...
            <p className="text-[10px] md:text-xs text-zinc-400 mt-1">
              If video buffers or loads slowly, click below to open the ultra-fast sponsor mirror network.
            </p>
          </div>
        </div>
